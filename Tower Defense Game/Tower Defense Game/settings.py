...
class Settings:
    ...
    def __init__(self):
        ...
        self.enemy_path = self.change_enemy_path(self.pathway)

        self.tower_sprites = {
            'basic': 'assets/towers/basic_tower.png',
            'sniper': 'assets/towers/sniper_tower.png',
            'money': 'assets/towers/towerDefense_tile203.png',
        }
    ...
    def change_enemy_path(self, pathway:list)->list:
        """
        This function changes the enemy path
        :param pathway: list of enemy paths
        :return: random enemy path
        """
        ind = random.randint(0, len(pathway) - 1)
        return self.pathway[ind]
